<div class="dropdown-container">
    <span id="sw_elm_sort_fields" class="sort-dropdown cm-combination cm-combo-on"><a>{__("sort_by_`$search.sort_by`_`$search.sort_order`")}<i class="icon-down-micro"></i></a></span>
