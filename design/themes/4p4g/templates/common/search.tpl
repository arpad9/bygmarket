...
{strip}
    ...
    {/if}
      <input type="text" name="q" value="{$search.q}" id="search_input{if $smarty.capture.search_input_id}_{$smarty.capture.search_input_id}{/if} appendedInputButton" title="{$search_title}" class="span6 input-texxt input-texxt-menu cm-hint"/>
      {if $settings.General.search_objects}
