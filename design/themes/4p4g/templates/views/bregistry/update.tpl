...
<div class="weddingInfoContainer">
	...
	<div class="registryInfoTitle">{$event_data.fname} {$event_data.lname}'s Birthday Registry</div>
	<div class="registryInfoWelcome"><span><b>Hello, {$user_info.firstname} {$user_info.lastname}</b> Welcome to your Birthday Registry.</span> ({include file="buttons/button.tpl" but_text="Manage Your Registry" but_href="bregistry.addreg&br_id=$registry_type_id" but_role="text" but_meta="modified"})</div>
	<div class="registryInfoPrivacy">
		...
		{/if}
		({include file="buttons/button.tpl" but_text="Change Settings" but_href="bregistry.addreg&br_id=$registry_type_id" but_role="text" but_meta="modified"})
	</div>
...
<form action="{""|fn_url}" method="post" name="birthday_registry_products_form" >
{*
<div class="buttons-container">
    &nbsp;{include file="buttons/button.tpl" but_text=__("update") but_name="dispatch[bregistry.update]"}
    <div class="float-left">
        {include file="pickers/products/picker.tpl" data_id="br_products" but_text=__("add_product") extra_var="bregistry.add_products?registry_type_id=`$registry_type_id`" no_container=true}
    </div>
</div>
*}
        ...
        <tbody>
            ...
            <tr>
                <td>
                    ...
                    <a href="{"bregistry.delete_product?item_id=`$key`&registry_type_id=`$registry_type_id`"|fn_url}" class="icon-delete-big" title="{__("remove")}"><i class="icon-cancel-circle"></i></a>
...
{include file="pickers/products/picker.tpl" data_id="br_products" but_text=__("add_product") extra_var="bregistry.add_products?registry_type_id=`$registry_type_id`"}
{/if}
</div>
