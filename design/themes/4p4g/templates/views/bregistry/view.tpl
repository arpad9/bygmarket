...
<div class="weddingInfoContainer">
	...
	<div class="registryInfoWelcome"><span><b>Birth Date:</b> {$event_data.event_date|date_format:'%B %d, %Y'}</span></div>
	{if $event_data.interests}
	<div class="registryInfoWelcome"><b>Interests:</b> 
		{assign var=inte value=","|explode:$event_data.interests}												
	...
	{/if}
	{if $event_data.about}
	<div class="registryInfoWelcome"><b>About:</b> {$event_data.about}</div>
	{/if}
</div>
{/if}
...
{else}
    <p class="no-items">{*__("text_no_products_defined")*}There are currently no items in this Registry.</p>
{/if}
