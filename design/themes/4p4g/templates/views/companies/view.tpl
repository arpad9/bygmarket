...
<div class="company-page clearfix">
    ...
    <div id="block_company_{$company_data.company_id}">
        ...
        <div class="company-page-top-links clearfix">
            ...
            <div id="company_products">
                <a href="{"products.search?company_id=`$company_data.company_id`&search_performed=Y"|fn_url}">{__("view_vendor_products")} ({$company_data.total_products} {__("items")})</a>
            </div>
            {/hook}
        </div>
        <div class="company-page-info">
            ...
            <div class="info-list">
                ...
                <div>
                    <span>{$company_data.city}, {$company_data.state|fn_get_state_name:$company_data.country} {$company_data.zipcode}</span>
                </div>
                <div>
