{if $cart_agreements || $settings.General.agree_terms_conditions == "Y"}
    ...
    //]]>
        ...
        <div class="control-group margin-top terms">
            {hook name="checkout:terms_and_conditions"}
            
            <label for="id_accept_terms{$suffix}" class="valign cm-check-agreement"><input type="checkbox" id="id_accept_terms{$suffix}" name="accept_terms" value="Y" class="cm-agreement checkbox valign" {if $iframe_mode}onclick="fn_check_agreements('{$suffix}');"{/if} />{__("checkout_terms_n_conditions")}</label>
            {/hook}
        </div>
        {/if}
        {if $cart_agreements}
        <div class="control-group license-agreement">
            ...
            <label for="product_agreements_{$suffix}" class="valign cm-check-agreement)"><span>{__("checkout_edp_terms_n_conditions")}</span>&nbsp;<a id="sw_elm_agreements_{$suffix}" class="cm-combination">{__("license_agreement")}</a><input type="checkbox" id="product_agreements_{$suffix}" name="agreements[]" value="Y" class="cm-agreement valign checkbox"  {if $iframe_mode}onclick="fn_check_agreements('{$suffix}');"{/if}/></label>
            {/hook}
