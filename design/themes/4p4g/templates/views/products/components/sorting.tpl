...
<span id="sw_elm_pagination_steps" class="sort-dropdown cm-combination cm-combo-on"><a>{$pagination.items_per_page} {__("per_page")}<i class="icon-down-micro"></i></a></span>
