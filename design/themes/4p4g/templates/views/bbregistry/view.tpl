...
<div class="weddingInfoContainer">
	...
	<div class="registryInfoWelcome"><span><b>Expected Baby Arrival Date:</b> {$event_data.event_date|date_format:'%B %d, %Y'}</span></div>
	{if $event_data.notes|trim }<div><b>Description:</b> {$event_data.notes|strip_tags|trim nofilter}</div>{/if}
</div>
{/if}
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="nowrap center">
                                        ...
                                        <input id="giftreg_id" type="hidden" name="product_data[{$key}][extra][events][registry_type_id]" value="{$event_data.bbr_id}"  />
