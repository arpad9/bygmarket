<div class="rma">
    <div class="rma-actions clearfix">
        <span><i class="icon-print"></i>{include file="buttons/button_popup.tpl" but_text=__("print_slip") but_href="rma.print_slip?return_id=`$return_info.return_id`" width="800" height="600" but_role="text"}</span>
