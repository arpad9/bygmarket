...
{/if}
    ...
    Searchanise.options.PriceFormat = {ldelim}rate : {$currencies[$secondary_currency].coefficient}, decimals: {$currencies[$secondary_currency].decimals}, decimals_separator: '{$currencies[$secondary_currency].decimals_separator}', thousands_separator: '{$currencies[$secondary_currency].thousands_separator}', symbol: '{$currencies[$secondary_currency].symbol}', after: {if $currencies[$secondary_currency].after == 'N'}false{else}true{/if}{rdelim};
