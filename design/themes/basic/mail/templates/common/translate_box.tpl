<div id="translate_link" class="hidden">
    <img src="{$images_dir}/icons/translate_icon.png" width="16" height="16" border="0" alt="{__("translate")}" title="{__("translate")}" onclick="fn_show_translate_box();" />
</div>
<div id="translate_box" class="hidden">
    ...
    <div class="buttons-container">
        {include file="buttons/save_cancel.tpl" but_type="button" but_onclick="fn_save_phrase();" but_text=__("save_translation") cancel_action="close" save=true}
    </div>
