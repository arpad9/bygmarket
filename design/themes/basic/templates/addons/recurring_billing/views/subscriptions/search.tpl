...
<thead>
    <tr>
        ...
        <th style="width: 1%" class="right">
            <img src="{$images_dir}/icons/plus_minus.gif" width="13" height="12" name="plus_minus" id="on_st" alt="{__("expand_collapse_list")}" title="{__("expand_collapse_list")}" class="hand cm-combinations-subscriptions" /><img src="{$images_dir}/icons/minus_plus.gif" width="13" height="12" name="minus_plus" id="off_st" alt="{__("expand_collapse_list")}" title="{__("expand_collapse_list")}" class="hand hidden cm-combinations-subscriptions" /></th>
    </tr>
</thead>
...
<tr class="{$row_class_name}">
    ...
    <td class="right nowrap">
        {if $additional_data|trim}
            <img src="{$images_dir}/icons/plus.gif" width="14" height="9" name="plus_minus" id="on_products_{$smarty.foreach.subscriptions.iteration}" alt="{__("expand_collapse_list")}" title="{__("expand_collapse_list")}" class="hand cm-combination-subscriptions" /><img src="{$images_dir}/icons/minus.gif" width="14" height="9" name="minus_plus" id="off_products_{$smarty.foreach.subscriptions.iteration}" alt="{__("expand_collapse_list")}" title="{__("expand_collapse_list")}" class="hand hidden cm-combination-subscriptions" /><a id="sw_products_{$smarty.foreach.subscriptions.iteration}" class="cm-combination-subscriptions">{__("extra")}</a>
        {else}
        &nbsp;
        {/if}
    </td>
