...
<tr>
    ...
    <th style="width: 1%" class="center">
        <img src="{$images_dir}/icons/plus_minus.gif" width="13" height="12" name="plus_minus" id="on_st" alt="{__("expand_collapse_list")}" title="{__("expand_collapse_list")}" class="hand cm-combinations-commissions" /><img src="{$images_dir}/icons/minus_plus.gif" width="13" height="12" name="minus_plus" id="off_st" alt="{__("expand_collapse_list")}" title="{__("expand_collapse_list")}" class="hand hidden cm-combinations-commissions" /></th>
</tr>
...
<tr class="{$row_class_name}">
    ...
    <td class="center nowrap">
        {if $row_stats.extra_data || $additional_data|strip_tags|trim}
            <img src="{$images_dir}/icons/plus.gif" width="14" height="9" name="plus_minus" id="on_commission_{$smarty.foreach.commissions.iteration}" alt="{__("expand_collapse_list")}" title="{__("expand_collapse_list")}" class="hand cm-combination-commissions" /><img src="{$images_dir}/icons/minus.gif" width="14" height="9" name="minus_plus" id="off_commission_{$smarty.foreach.commissions.iteration}" alt="{__("expand_collapse_list")}" title="{__("expand_collapse_list")}" class="hand hidden cm-combination-commissions" /><a id="sw_commission_{$smarty.foreach.commissions.iteration}" class="cm-combination-commissions">{__("extra")}</a>
        {else}
        &nbsp;
        {/if}
    </td>
