            ...
            <tr>
                <td class="product-description">
                    ...
                    <div class="quick-view">
                        ...
                        <span class="button button-wrap-right"><a id="opener_gift_cert_picker_{$gift_key}" class="cm-dialog-opener cm-dialog-auto-size" data-ca-target-id="gift_cert_quick_view_{$gift_key}" href="{"gift_certificates.update?gift_cert_wishlist_id=`$gift_key`"|fn_url}">{__("quick_view")}</a></span>
                        </span>
                    </div>
                </td>
            </tr>
            ...
            <div class="hidden" id="gift_cert_quick_view_{$gift_key}" title="{__("gift_certificate")}">
                ...
                <div class="product-container wishlist-wrap">
                    <div class="float-left center">
                        <div class="cm-image-wrap wishlist-image">
