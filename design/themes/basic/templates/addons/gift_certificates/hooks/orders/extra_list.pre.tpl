...
<tr>
    <td>
        <div class="float-right">{include file="buttons/button_popup_link.tpl" but_href="gift_certificates.print?order_id=`$order_info.order_id`&gift_cert_cart_id=`$gift_key`" but_text=__("print_card") but_role="text" width="750" height="350"}</div>
        ...
        <div class="details-block">
            <a id="sw_options_{$gift_key}" class="cm-combo-on cm-combination"><i>{__("text_click_here")}</i></a>
