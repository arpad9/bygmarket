...
{else}
    ...
    <div class="compare-menu">
        <ul>
            <li>{if $action != "show_all"}<a href="{"product_features.compare.show_all"|fn_url}">{__("all_features")}</a>{else}<span>{__("all_features")}{/if}</span></li>
            <li>{if $action != "similar_only"}<a href="{"product_features.compare.similar_only"|fn_url}">{__("similar_only")}</a>{else}<span>{__("similar_only")}{/if}</span></li>
            <li>{if $action != "different_only"}<a href="{"product_features.compare.different_only"|fn_url}">{__("different_only")}</a>{else}<span>{__("different_only")}{/if}</span></li>
        </ul>
    </div>
