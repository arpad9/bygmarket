<div class="quick-view">
    <span class="button button-wrap-left">
        ...
        {/if}
        <span class="button button-wrap-right"><a class="cm-dialog-opener cm-dialog-auto-size" data-ca-view-id="{$product.product_id}" data-ca-target-id="product_quick_view" href="{$quick_view_url|fn_url}" data-ca-dialog-title="{__("quick_product_viewer")}">{__("quick_view")}</a></span>
    </span>
</div>