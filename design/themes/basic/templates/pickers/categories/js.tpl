...
{if $multiple}
    ...
    &nbsp;<a onclick="Tygh.$.cePicker('delete_js_item', '{$holder}', '{$category_id}', 'c'); return false;"><img width="12" height="18" class="hand valign" alt="" src="{$images_dir}/icons/icon_delete.gif"/></a>
    {/if}
{else}
