...
{capture name="tabsbox"}
        ...
        {foreach $upgrade_packages as $type => $packages}
            {foreach $packages as $_id => $package}
                ...
                <form name="upgrade_form_{$type}_{$id}" method="post" action="{fn_url()}" class="form-horizontal form-edit cm-disable-check-changes">
                    ...
                    <div class="hidden upgrade-center_wizard" id="content_upgrade_center_wizard" title="{__("warning")}">
                        <div class="upgrade_center_wizard-msg">
                            <p class="text-error lead">
                            ...
                            <blockquote>
                                ...
                                <p>{__("upgrade_center.warning_msg_generally")}<br><br>                                
                                    <input type="submit" name="dispatch[upgrade_center.check_timeout]" class="btn cm-ajax cm-comet cm-post" value="{__("check_php_timeout")}" id="check_timeout">
                                </p>
                                <br>
                            </blockquote>
                        </div>
    ...
    <div class="upgrade-center" id="content_installed_upgrades">
    ...
    <script type="text/javascript">
        ...
        (function(_, $){
            ...
            $('#check_timeout').on('click', function() {
                var timer;
