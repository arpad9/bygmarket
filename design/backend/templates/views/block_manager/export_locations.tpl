...
<div class="buttons-container">
    {include file="buttons/save_cancel.tpl" but_text=__("export") but_name="dispatch[block_manager.export_locations]" cancel_action="close" but_meta="cm-dialog-closer"}
</div>
</form>