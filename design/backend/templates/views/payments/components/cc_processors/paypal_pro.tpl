...
<div class="control-group">
    ...
    <div class="controls">
        ...
        <input type="text" name="payment_data[processor_params][certificate_filename]" id="certificate_filename" value="{$processor_params.certificate_filename}" class="pull-left">
    </div>
</div>
