...
{capture name="buttons"}
    {if $id}
        ...
        {if "ULTIMATE"|fn_allowed_for}
            {assign var="view_uri" value="categories.view?category_id=`$id`&company_id=`$category_data.company_id`"}
            {assign var="view_uri_escaped" value="`$view_uri`&action=preview"|fn_url:'C':'http':$smarty.const.DESCR_SL|escape:"url"}
        {/if}
        {/capture}
        ...
        {capture name="tools_list"}
            ...
            <li>{btn type="list" target="_blank" text=__("preview") href=$view_uri|fn_url:'C':'http':$smarty.const.DESCR_SL}</li>
