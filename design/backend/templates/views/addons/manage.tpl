            ...
            <td width="15%">
                ...
                {else}
                    <div class="pull-right nowrap">
                        {include file="common/select_popup.tpl" popup_additional_class="dropleft" id=$key status=$a.status hide_for_vendor=$hide_for_vendor non_editable=!$a.snapshot_correct display=$display update_controller="addons"}
                    </div>
                {/if}
            </td>
        <!--addon_{$key}--></tr>
...
{/capture}
{include file="common/mainbox.tpl" title=__("addons") content=$smarty.capture.mainbox sidebar=$smarty.capture.sidebar}