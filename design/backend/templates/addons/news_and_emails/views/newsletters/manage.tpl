...
<tr class="cm-row-status-{$newsletter.status|lower}">
    ...
    <td class="right" width="10%">
        {include file="common/select_popup.tpl" id=$newsletter.newsletter_id status=$newsletter.status items_status="news"|fn_get_predefined_statuses object_id_name="newsletter_id" table="newsletters"}
    </td>
</tr>
{/foreach}
</tbody>
