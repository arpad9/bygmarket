...
<tr>
    <td class="left"><input type="checkbox" name="affiliate_plan[product_ids][]" value="{$product_id}" class="cm-item" /></td>
    <td>
        {if !"ULTIMATE"|fn_allowed_for}
...
<tr>
    <td class="left"><input type="checkbox" name="affiliate_plan[category_ids][]" value="{$category.category_id}" class="cm-item" /></td>
    <td>
        {if !"ULTIMATE"|fn_allowed_for}
...
<input type="hidden" name="plan_id" value="{$id}" />
    ...
    {if $coupons}
        ...
        <tr>
            <td class="left">
                <input type="checkbox" name="promotion_ids[]" value="{$coupon.promotion_id}" class="cm-item" /></td>
            <td>
...
<tr>
    <td class="left">
        <input type="checkbox" name="affiliate_plan[promotion_ids][]" value="{$coupon.promotion_id}" class="cm-item" /></td>
    <td width="60%">
        {if $allow_save}
