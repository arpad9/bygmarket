{capture name="mainbox"}
    ...
    <tr>
        ...
        {include file="common/popupbox.tpl" id="banner_stats_`$banner.banner_id`" text=__("statistics") link_text=__("details") act="edit" href="statistics.banner_stats?banner_id=`$banner.banner_id`&time_from=`$search.time_from`&time_to=`$search.time_to`" icon="icon-list-alt"}
            </div>
        </td>
    </tr>
    {/foreach}
