...
{if $view == "input"}
    <input type="text" name="{$input_name}" value="{$value}" class="cm-numeric {$class}" data-a-sign="{$currencies.$primary_currency.symbol}" {if $currencies.$primary_currency.after == "Y"}data-p-sign="s"{/if} data-a-dec="." data-a-sep=",">
{else}
