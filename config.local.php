...
$config['db_name'] = 'bygmarket';
$config['db_user'] = 'bygmarket';
$config['db_password'] = 'okos8gye';
...
$config['http_host'] = 'store.bygmarket.com';
$config['http_path'] = '';

// Host and directory where software is installed on secure server
$config['https_host'] = 'store.bygmarket.com';
$config['https_path'] = '';
...
$config['admin_index']    = 'admin_nogrifufEfzeec6.php';
