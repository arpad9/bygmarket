<?php /* Smarty version Smarty-3.1.21, created on 2015-09-18 21:28:43
         compiled from "/var/www/bygmarket.com/design/themes/responsive/templates/addons/gift_certificates/views/gift_certificates/update.tpl" */ ?>
<?php /*%%SmartyHeaderCode:97101339355fc57db764f99-39945574%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'c2440fc90866504867a238ca2d80b39e62d9641a' => 
    array (
      0 => '/var/www/bygmarket.com/design/themes/responsive/templates/addons/gift_certificates/views/gift_certificates/update.tpl',
      1 => 1442595902,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '97101339355fc57db764f99-39945574',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_55fc57dbb194a8_50471070',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_55fc57dbb194a8_50471070')) {function content_55fc57dbb194a8_50471070($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include '/var/www/bygmarket.com/app/functions/smarty_plugins/block.hook.php';
...
<div class="ty-control-group ty-gift-certificate__amount">
    ...
    <input type="text" id="gift_cert_amount" name="gift_cert_data[amount]" class="ty-gift-certificate__amount-input cm-numeric" data-p-sign="s" data-a-sep="" <?php if ($_smarty_tpl->tpl_vars['currencies']->value[$_smarty_tpl->tpl_vars['secondary_currency']->value]['decimals_separator']) {?>data-a-dec="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['currencies']->value[$_smarty_tpl->tpl_vars['secondary_currency']->value]['decimals_separator'], ENT_QUOTES, 'UTF-8');?>
"<?php }?> size="5" value="<?php if ($_smarty_tpl->tpl_vars['gift_cert_data']->value) {
...
" disabled="disabled"  />
        ...
        <div class="ty-control-group zipcode">
            ...
            <input type="text" id="gift_cert_zipcode" name="gift_cert_data[zipcode]" class="ty-input-text-short" size="50" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['gift_cert_data']->value['zipcode'], ENT_QUOTES, 'UTF-8');?>
" />
        </div>
