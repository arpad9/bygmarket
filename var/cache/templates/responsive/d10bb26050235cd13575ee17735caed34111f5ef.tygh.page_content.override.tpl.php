<?php /* Smarty version Smarty-3.1.21, created on 2015-09-18 21:27:19
         compiled from "/var/www/bygmarket.com/design/themes/responsive/templates/addons/form_builder/hooks/pages/page_content.override.tpl" */ ?>
<?php /*%%SmartyHeaderCode:151159670455fc5787798279-02202639%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'd10bb26050235cd13575ee17735caed34111f5ef' => 
    array (
      0 => '/var/www/bygmarket.com/design/themes/responsive/templates/addons/form_builder/hooks/pages/page_content.override.tpl',
      1 => 1442595906,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '151159670455fc5787798279-02202639',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_55fc5787b22c88_75566559',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_55fc5787b22c88_75566559')) {function content_55fc5787b22c88_75566559($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include '/var/www/bygmarket.com/app/functions/smarty_plugins/block.hook.php';
if (!is_callable('smarty_modifier_in_array')) include '/var/www/bygmarket.com/app/functions/smarty_plugins/modifier.in_array.php';
...
if ($_smarty_tpl->tpl_vars['page']->value['page_type']==@constant('PAGE_TYPE_FORM')) {?>
    <?php if ($_REQUEST['sent']=="Y") {?>
        ...
        <?php echo $_smarty_tpl->getSubTemplate ("buttons/button.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('but_text'=>__("continue"),'but_meta'=>"ty-btn__secondary",'but_href'=>fn_url($_smarty_tpl->tpl_vars['continue_url']->value),'but_role'=>"action"), 0);?>
...
" <?php if ($_smarty_tpl->tpl_vars['_country']->value==$_smarty_tpl->tpl_vars['code']->value) {?>selected="selected"<?php }?>><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['country']->value, ENT_QUOTES, 'UTF-8');?>
            ...
            <?php } elseif ($_smarty_tpl->tpl_vars['element']->value['element_type']==@constant('FORM_STATES')) {?>
                ...
                <select class="ty-form-builder__state cm-state cm-location-billing" id="elm_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['element']->value['element_id'], ENT_QUOTES, 'UTF-8');?>
" name="form_values[<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['element']->value['element_id'], ENT_QUOTES, 'UTF-8');?>
]">
                    <option label="" value="">- <?php echo $_smarty_tpl->__("select_state");?>
 -</option>
                </select>
                <input type="text" class="cm-state cm-location-billing ty-input-text hidden" id="elm_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['element']->value['element_id'], ENT_QUOTES, 'UTF-8');?>
...
" disabled="disabled" />
    ...
    <div class="ty-form-builder__buttons buttons-container">
        <?php echo $_smarty_tpl->getSubTemplate ("buttons/button.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('but_role'=>"submit",'but_text'=>__("submit"),'but_meta'=>"ty-btn__secondary",'but_name'=>"dispatch[pages.send_form]"), 0);?>
