<?php /* Smarty version Smarty-3.1.21, created on 2015-09-19 01:54:53
         compiled from "/var/www/bygmarket.com/design/backend/templates/views/block_manager/manage.tpl" */ ?>
<?php /*%%SmartyHeaderCode:49220509155fc963de70df7-89123379%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b323baf371c02a58460ed74c8ba908ba4658fd33' => 
    array (
      0 => '/var/www/bygmarket.com/design/backend/templates/views/block_manager/manage.tpl',
      1 => 1441800576,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '49220509155fc963de70df7-89123379',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_55fc963e1182f2_02260979',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_55fc963e1182f2_02260979')) {function content_55fc963e1182f2_02260979($_smarty_tpl) {?><?php if (!is_callable('smarty_function_script')) include '/var/www/bygmarket.com/app/functions/smarty_plugins/function.script.php';
...
if (!is_callable('smarty_function_render_location')) include '/var/www/bygmarket.com/app/functions/smarty_plugins/function.render_location.php';
...
<?php echo $_smarty_tpl->getSubTemplate ("common/popupbox.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('text'=>__("export_layout"),'content'=>Smarty::$_smarty_vars['capture']['export_layout'],'id'=>"export_layout_manager"), 0);?>
...
<?php echo $_smarty_tpl->getSubTemplate ("common/popupbox.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('text'=>__("import_layout"),'content'=>Smarty::$_smarty_vars['capture']['import_layout'],'id'=>"import_layout_manager"), 0);?>
...
<?php $_smarty_tpl->_capture_stack[0][] = array("buttons", null, null); ob_start(); ?>
    ...
    <?php if (!$_smarty_tpl->tpl_vars['dynamic_object']->value['object_id']) {?>
        <?php $_smarty_tpl->_capture_stack[0][] = array("tools_list", null, null); ob_start(); ?>
            ...
            <li class="divider"></li>
            <li>
                <?php echo $_smarty_tpl->getSubTemplate ("common/popupbox.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('id'=>"export_layout_manager",'link_text'=>__("export_layout"),'act'=>"link",'content'=>'','general_class'=>"action-btn"), 0);?>

            </li>
            <li>
                <?php echo $_smarty_tpl->getSubTemplate ("common/popupbox.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('id'=>"import_layout_manager",'link_text'=>__("import_layout"),'act'=>"link",'link_class'=>"cm-dialog-auto-size",'content'=>'','general_class'=>"action-btn"), 0);?>
...
$_tmp3=ob_get_clean();?><?php smarty_template_function_btn($_smarty_tpl,array('type'=>"list",'text'=>__("preview"),'href'=>$_tmp3,'target'=>"_blank"));?>
                            ...
                            <li><?php smarty_template_function_btn($_smarty_tpl,array('type'=>"list",'text'=>__("make_default"),'href'=>"block_manager.set_default_layout?layout_id=".((string)$_smarty_tpl->tpl_vars['layout']->value['layout_id']),'class'=>"cm-ajax cm-post",'data'=>array("data-ca-target-id"=>"block_manager_sidebar")));?>
</li>
                            <?php }?>
...
$_tmp4=ob_get_clean();?><?php echo $_smarty_tpl->getSubTemplate ("common/popupbox.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('id'=>"upate_layout_".((string)$_smarty_tpl->tpl_vars['layout']->value['layout_id']),'text'=>$_tmp4.": ".((string)$_smarty_tpl->tpl_vars['layout']->value['name']),'content'=>Smarty::$_smarty_vars['capture']['add_new_picker'],'act'=>"link",'link_text'=>__("properties")), 0);?>
                            ...
                            <?php if (!$_smarty_tpl->tpl_vars['layout']->value['is_default']) {?>
                                <li class="divider"></li>
                                <li><?php smarty_template_function_btn($_smarty_tpl,array('type'=>"list",'text'=>__("delete"),'href'=>"block_manager.delete_layout?layout_id=".((string)$_smarty_tpl->tpl_vars['layout']->value['layout_id']),'class'=>"cm-confirm cm-post"));?>
</li>
                            <?php }?>
                        <?php list($_capture_buffer, $_capture_assign, $_capture_append) = array_pop($_smarty_tpl->_capture_stack[0]);
if (!empty($_capture_buffer)) {
