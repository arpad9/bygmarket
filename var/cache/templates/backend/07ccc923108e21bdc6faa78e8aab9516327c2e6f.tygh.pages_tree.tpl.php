<?php /* Smarty version Smarty-3.1.21, created on 2015-09-19 00:32:45
         compiled from "/var/www/bygmarket.com/design/backend/templates/views/pages/components/pages_tree.tpl" */ ?>
<?php /*%%SmartyHeaderCode:74701805255fc82fd8252b9-70143360%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '07ccc923108e21bdc6faa78e8aab9516327c2e6f' => 
    array (
      0 => '/var/www/bygmarket.com/design/backend/templates/views/pages/components/pages_tree.tpl',
      1 => 1441800576,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '74701805255fc82fd8252b9-70143360',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_55fc82fdb13612_14213864',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_55fc82fdb13612_14213864')) {function content_55fc82fdb13612_14213864($_smarty_tpl) {?><?php if (!is_callable('smarty_function_math')) include '/var/www/bygmarket.com/app/lib/vendor/smarty/smarty/libs/plugins/function.math.php';
?><?php
...
if ($_smarty_tpl->tpl_vars['expand_all']->value) {?> hidden<?php }?>" ><span class="exicon-expand "></span></span>
            <span alt="<?php echo $_smarty_tpl->__("expand_collapse_list");?>
" title="<?php echo $_smarty_tpl->__("expand_collapse_list");?>
" id="off_page<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['combination_suffix']->value, ENT_QUOTES, 'UTF-8');?>
" class="cm-combinations-pages<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['combination_suffix']->value, ENT_QUOTES, 'UTF-8');
if (!$_smarty_tpl->tpl_vars['expand_all']->value) {?> hidden<?php }?>" ><span class="exicon-collapse "></span></span>
        <?php }?>
...
" class="hidden" />
    ...
    <td class="row-status" width="70%">
        <div class="text-over" <?php if ($_smarty_tpl->tpl_vars['search']->value['get_tree']=="multi_level") {?>style="padding-left: <?php echo smarty_function_math(array('equation'=>"x*14",'x'=>(($tmp = @$_smarty_tpl->tpl_vars['page']->value['level'])===null||$tmp==='' ? 0 : $tmp)),$_smarty_tpl);?>
...
_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['page']->value['page_id'], ENT_QUOTES, 'UTF-8');?>
" class="cm-combination-pages<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['combination_suffix']->value, ENT_QUOTES, 'UTF-8');?>
 <?php if (!$_smarty_tpl->tpl_vars['expand_all']->value||$_smarty_tpl->tpl_vars['hide_show_all']->value) {?>hidden<?php }?>"><span class="exicon-collapse"></span> </span><?php } elseif ($_smarty_tpl->tpl_vars['search']->value['get_tree']=="multi_level") {?><span style="padding-left: 14px;">&nbsp;</span><?php }
...
" />
        <?php $_smarty_tpl->_capture_stack[0][] = array("tools_list", null, null); ob_start(); ?>
            ...
            <?php if (fn_allowed_for("ULTIMATE")&&$_smarty_tpl->tpl_vars['allow_save']->value||!fn_allowed_for("ULTIMATE")) {?>
                <li><?php smarty_template_function_btn($_smarty_tpl,array('type'=>"list",'text'=>__("delete"),'class'=>"cm-confirm cm-post",'href'=>"pages.delete?page_type=".((string)$_smarty_tpl->tpl_vars['page']->value['page_type'])."&page_id=".((string)$_smarty_tpl->tpl_vars['page']->value['page_id']).((string)$_smarty_tpl->tpl_vars['multi_level']->value)."&come_from=".((string)$_smarty_tpl->tpl_vars['_come_from']->value)));?>
</li>
            <?php }?>
