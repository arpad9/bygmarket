...
function fn_twg_get_admin_settings($auth)
{
    ...
    $settings['user_company_id'] = isset($auth['company_id']) ? $auth['company_id'] : $settings['user_company_id'];
