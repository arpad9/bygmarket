{if $product.recurring_plans && !$product.recurring_plans.0 && !($runtime.controller == "products" && ($runtime.mode == "view" || $runtime.mode == "options")) && $wishlist|fn_cart_is_empty}
...
{elseif $product.recurring_plans && $runtime.controller == "products" && ($runtime.mode == "view" || $runtime.mode == "options") && $subscription_object_id}
    <{if $separate_buttons}div class="buttons-container"{else}span{/if}>
